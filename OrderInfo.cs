...
namespace zk
{
    public class OrderInfo
    {
        ...
        public Order_Op_Content[] ooc=new Order_Op_Content[100];
        public Order_Op_Status[] oos=new Order_Op_Status[100];

        public OrderInfo()
        {
        }

       public OrderInfo(Order a)
       {
          this.orderID=a.orderId;
          this.orderCode=a.orderCode;
          OrderOp[] oops=new OrderOp[100];               //
          oops=a.orderOpList.ToArray();                         //
          int i=0;
          foreach(OrderOp oop in oops)                          //初始化ooc及oos内容
          {
              ...
              this.ooc[i]=new Order_Op_Content();
                ...
                this.oos[i].orderCode=oop.orderCode;
    ...
    public class Order_Op_Status                //调度指令在系统中的状态及反馈信息
    {
        ...
        public string clientReceiveTime;
